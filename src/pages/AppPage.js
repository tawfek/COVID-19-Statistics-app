...
<Statistic
        ...
        prefix={<TeamOutlined />}
        suffix={  <Badge count={Render_status.cases.new+' '+__("New")}></Badge> }/>
</Col>
...
title={__("Deaths")}
valueStyle={{ color: '#cf1322' }}
suffix={  <Badge count={(Render_status.deaths.new===null)?0:Render_status.deaths.new+' '+__("New")}></Badge> }
